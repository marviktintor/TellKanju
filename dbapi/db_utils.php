...
class db_utils{
	...
	public function __construct($host = "localhost",$user = "root",$password = "",$database = "atc_tell_kanju"){ 
	...
	function resetAutoIncrement($table,$printSQL = false){
		if(empty($table)){
			throw new NullabilityException("The table name cannot be null");
		}
	...
	function renameTable($oldname,$newname,$printSQL = false){
